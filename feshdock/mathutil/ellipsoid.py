...
from feshdock.error.lightdock_errors import MinimumVolumeEllipsoidError
...
class MinimumVolumeEllipsoid(object):
    ...
    def _get_min_vol_ellipsoid(self):
        """Finds the minimum volume ellipsoid which contains the set of given points找到包含所有点的最小椭圆"""
