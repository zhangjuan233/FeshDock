...
import os
from feshdock.mathutil.cython.cutil import float_equals as cfloat_equals
from feshdock.mathutil.cython.cutil import norm as cnorm
from feshdock.mathutil.cython.cutil import sum_of_squares as csum_of_squares
from feshdock.mathutil.cython.cutil import (
    sum_of_square_difference as csum_of_square_difference,
)
...
class Coordinates(object):
    ...
    def move(self, other, step=1.0):
        """Move from one coordinate to another a given step 向邻居移动"""
        if self != other:
            delta_x = other - self
