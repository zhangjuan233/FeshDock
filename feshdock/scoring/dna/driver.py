...
import feshdock.scoring.dna.energy.c.cdna as cdna
import feshdock.scoring.dna.energy.parameters as parameters
from feshdock.util.logger import LoggingManager
import feshdock.scoring.dna.data.amber as amber
import feshdock.scoring.dna.data.vdw as vdw
...
class DNA(ScoringFunction):
    ...
    def __call__(self, receptor, receptor_coordinates, ligand, ligand_coordinates):
        ...
        """
        elec, vdw, interface_receptor, interface_ligand = cdna.calculate_energy(
        ...
        energy = (elec + parameters.scoring_vdw_weight * vdw) * -1.0
