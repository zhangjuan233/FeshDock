...
from feshdock.scoring.functions import ScoringFunction, ModelAdapter
from feshdock.structure.model import DockingModel
import feshdock.scoring.cpydock.energy.c.cpydock as cpydock
import feshdock.scoring.cpydock.energy.parameters as parameters
from feshdock.util.logger import LoggingManager
import feshdock.scoring.cpydock.data.amber as amber
import feshdock.scoring.cpydock.data.vdw as vdw
import feshdock.scoring.cpydock.data.solvation as solvation
from protein.constants import DEFAULT_CONTACT_RESTRAINTS_CUTOFF
from feshdock.error.lightdock_errors import NotSupportedInScoringError
...
class CPyDock(ScoringFunction):
    ...
    def __call__(self, receptor, receptor_coordinates, ligand, ligand_coordinates):
        ...
        solv = -1 * (solv_rec + solv_lig)  #取反
        energy = (elec + parameters.scoring_vdw_weight * vdw + solv) * -1.0 #取反
